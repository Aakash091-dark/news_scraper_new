...
def thehindu_markets_rss(rss_url, json_file, csv_file, source, source_category):
    ensure_directories()
    ...
    print(f"Log saved to: log/rss_statistics_thehindu_markets.csv")
...
if __name__ == "__main__":
    ...
    json_data = thehindu_markets_rss(url)
    print(json_data)